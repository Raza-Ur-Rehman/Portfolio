...
const Contact = () => {
 ...
 const socialLinks = [
  {
    href: "https://www.github.com/Raza-ur-Rehman",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/Raza-ur-Rehman786",
    icon: (
      <svg
        width="24"
        height="24"
    ...
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
          <h2 className="headline_2 lg:max-w-[12ch]">Contact me for collaboration</h2>
        ...
        <form action="" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:gap-2 md:grid-cols-2 ">
            <div className="mb-4">
              ...
              <input type="text" id="name" placeholder="Raza Ur Rehman" name="name" className="text-field" autoComplete="name" required />
            </div>
            <div className="">
              <label htmlFor="email" className="label">
                Email
              </label>
              <input type="email" id="email" placeholder="raza@example.com" name="email" className="text-field" autoComplete="email" required />
            </div>
          </div>
          ...
          <div className="">
            ...
            <textarea name="message" id="message" className="text-field" placeholder="Hi!" required></textarea>
          </div>
